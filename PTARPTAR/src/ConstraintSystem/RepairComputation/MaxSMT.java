...
public class MaxSMT {
	...
	public static void repairValuesComputation(String smt2filePath, List<VariationVariable> vvs) {
		try
        {
            log();
	...
	private static void saveSATModels(List<Model> satModels, List<IntExpr> exps) {
		...
		Utility.writeToFile("savedModels.txt", sb.toString().strip());
	}
